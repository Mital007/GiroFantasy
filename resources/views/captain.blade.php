...
<html lang="en">
    <head>
        ...
        <title> Giro Fantasy- Select Captain</title>
        <!-- favicon -->
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="breadcrumb-content">
                            <h2 class="title">Select Captain and Vice-Captain</h2>
                            <p>The captain will give you 2x points scored by them in the actual match.
                    ...
                    <!-- <nav class="navbar navbar-expand-lg"> -->
                        ...
                        <!-- <div class="collapse navbar-collapse" id="navbarSupportedContent2"> -->
                            <!-- <ul class="navbar-nav mr-auto"> -->
                                <!-- <li class="nav-item"> -->
                                    <!-- <a class="nav-link active" href="#">Ind vs Eng</a> -->
                                <!-- </li> -->
                                <!-- <li class="nav-item"> -->
                        ...
                        <div class="col-xl-6 col-lg-4 col-md-6 col-sm-6">
                               <div class="single-statics">
                                ...
                                <div class="part-info col-md-4">
                                    <span class="number">M Bhanuka</span>
                                    <span class="text">SRL</span>
                                </div>
                                ...
                                <!-- </div> -->
                                 <div class="text-center">
                                           <button class="place-bet-btn def-btn def-small">C</button> 
                                         </div> 
								&nbsp;&nbsp;&nbsp;
								 <div class="text-center">
                                           <button class="place-bet-btn def-btn def-small">VC</button> 
                                         </div> 
                            </div>
                        </div>
                      <!--  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="col-xl-6 col-lg-4 col-md-6 col-sm-6">
                              <div class="single-statics">
                                ...
                                <div class="part-info col-md-4">
                                    <span class="number">I Kishan</span>
                                    <span class="text">IND</span>
                                </div>
                                <!-- <div class="part-info col-md-3"> -->
                                    <!-- <span class="number">50 Coins</span> -->
                                    <!-- <span class="text">Enter</span> -->
						 ...
						 <div class="col-xl-6 col-lg-4 col-md-6 col-sm-6">
                          <div class="single-statics">
                                ...
                                <div class="part-info col-md-4">
                                    <span class="number">S Dhavan</span>
                                    <span class="text">IND</span>
                                </div>
                                <!-- <div class="part-info col-md-3"> -->
                                    <!-- <span class="number">50 Coins</span> -->
                                ...
                                <div class="view-more-btn text-center my-auto ">
									<button type="button" class="def-btn">Join Contest</button>
                                </div>
