...
<html lang="en">
    <head>
        ...
        <title> Giro Fantasy- my account</title>
        <!-- favicon -->
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-4 col-md-12 col-sm-12">
                            <div class="single-statics">
                                <div class="part-info col-md-2"></div>
                                <div class="part-icon part-info col-md-2 text-center">
                                    <br>
                                   <span><img src="assets/img/user-icon/prof.png" alt=""> </span> <br>
                                    <span class="number">User Name</span> <br>
                                    

                                </div>
                                <div class="part-info col-md-2"></div>
                               
                                <div class="part-info col-md-6">
                                    
                                    <span class="number">Email:</span>
                                    <span class="text">user@gmail.com</span> <br>
                                    <span class="number">Phone:</span>
                                    <span class="text">123456789</span> <br>
