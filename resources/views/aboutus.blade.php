...
<html lang="en">
    <head>
        ...
        <title> Giro Fantasy - About Us</title>
        <!-- favicon -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-sm-10 col-md-12 d-xl-flex d-lg-flex d-block align-items-center">
                        <div>
                            <div class="part-text">
                                ...
                                <p>Fantasy sports has become a craze in the past decade. We are proud to announce that Giro Fintech is growing and Giro Fantasy is going to be a part of us that will be a great source of entertainment to all the Sports Enthusiasts out there.</p>
                                <p></p>
                            ...
                            <div class="part-address">
                                <div class="addressing">
                                    <div class="single-address">
                                        <h4>Our Office</h4>
                                        <p>Gate Avenue at DIFC, Zone - D Level 1, Office 208 - 215 SZR,<br/>
                                            Dubai, UAE</p>
                                    </div>
                                    <div class="single-address">
                                        <h4>Email</h4>
